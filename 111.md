...
<!-- LOGOS BEGIN -->
<img src="https://foundata.com/de/netzwerk-automatisierung-sdn-netops/Ansible_logo.svg" alt="Ansible" height="64" />
<img src="https://raw.githubusercontent.com/foundata/ansible-docsmith/refs/heads/main/assets/ansible-docsmith-logo-draft-02.svg" alt="DocSmith for Ansible" height="64" />
<!-- LOGOS END -->


[![Ansible collection version](https://img.shields.io/ansible/collection/v/foundata/ansible-docsmith?logo=ansible)](https://galaxy.ansible.com/ui/repo/published/foundata/ansible-docsmith/)
[![PyPI package version](https://img.shields.io/pypi/v/ansible-docsmith.svg?logo=pypi)](https://pypi.org/project/ansible-docsmith)


> **⭐ Found this useful? Drop a star ⭐** on your preferred platform. It helps us sharing open-source tools for the community.
> 
...
> [![openCode repository](https://img.shields.io/gitlab/stars/foundata/ansible-docsmith?gitlab_url=https%3A%2F%2Fgitlab.opencode.de%2F&logo=gitlab)](https://gitlab.opencode.de/foundata/ansible-docsmith)
...
* **This project is *not* associated with [Red Hat](https://www.redhat.com/) nor the [Ansible project](https://ansible.com/).**
